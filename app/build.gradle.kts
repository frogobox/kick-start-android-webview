...
android {
    ...
    defaultConfig {
        ...
        resValue("string", "admob_app_id", AdmobValue.Debug.APP_ID)
        resValue("string", "admob_banner", AdmobValue.Debug.BANNER)
        resValue("string", "admob_interstitial", AdmobValue.Debug.INTERSTITIAL)
    ...
    buildTypes {
        ...
        getByName("release") {
            ...
            resValue("string", "admob_app_id", AdmobValue.APP_ID)
            resValue("string", "admob_banner", AdmobValue.BANNER)
            resValue("string", "admob_interstitial", AdmobValue.INTERSTITIAL)
